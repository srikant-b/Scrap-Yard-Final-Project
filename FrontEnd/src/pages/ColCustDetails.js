...
//         axios.get("/api/colCusDetails").then((resp) = {
//             // console.log("cus data fetched from order table");
//             setCusData(resp.Data.cusData)
//     })
//         console.log("cus data fetched from order table");
// }
...
//             <div className="row">
//                 <div className="col-4">
//                     <button className='btn btn-primary' onClick={() => fetchCusDataFromOrder()}>Accept</button>
//                 </div>
//             </div>
//         </div>
